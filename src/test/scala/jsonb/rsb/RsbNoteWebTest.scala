...
class RsbNoteWebTest extends FunSuite {
  ...
  private def verseRange(bookInfo: BookInfo, title: String): VerseRange = {
    ...
    title match {
      case twoNumberRegex(s1, s2) =>
        ...
        val singleVerse: SingleVerse = SingleVerse(bookInfo, chapter, verse)
      ...
      case threeNumberRegex(s1, s2, s3) =>
        ...
        VerseRange(SingleVerse(bookInfo, chapter, verse1),
          SingleVerse(bookInfo, chapter, verse1))
      ...
      case fourNumberRegex(s1, s2, s3, s4) =>
        ...
        VerseRange(SingleVerse(bookInfo, chapter1, verse1),
          SingleVerse(bookInfo, chapter2, verse2))
